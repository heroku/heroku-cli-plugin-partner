# Contributing Guide For Heroku CLI Partner plugin

This page lists the operational governance model of this project, as well as the
recommendations and requirements for how to best contribute to the Heroku CLI
Partner plugin. We strive to obey these as best as possible. As always, thanks for
...
- If you find a bug, please search for it in the
  [Issues](https://github.com/heroku/heroku-cli-plugin-partner/issues), and if
  it isn't already tracked,
  [create a new issue](https://github.com/heroku/heroku-cli-plugin-partner/issues/new).
...
- If you'd like to add new functionality to this project, describe the problem
  ...
  [new Issue](https://github.com/heroku/heroku-cli-plugin-partner/issues/new).
...
- If its a trivial change, go ahead and
  ...
  mind.
- If not,
  [open an Issue](https://github.com/heroku/heroku-cli-plugin-partner/issues/new)
